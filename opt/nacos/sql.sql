create table confcenter.config_info
(
...
create table confcenter.config_info_aggr
(
    id           bigint auto_increment comment 'id'
        primary key,
    data_id      varchar(255)            not null comment 'data_id',
...
create table confcenter.config_info_beta
(
    id                 bigint auto_increment comment 'id'
        primary key,
    data_id            varchar(255)                           not null comment 'data_id',
...
create table confcenter.config_info_tag
(
    id           bigint auto_increment comment 'id'
        primary key,
    data_id      varchar(255)                           not null comment 'data_id',
...
create table confcenter.config_tags_relation
(
...
create index idx_tenant_id
    on confcenter.config_tags_relation (tenant_id);

create table confcenter.group_capacity
(
...
create table confcenter.his_config_info
(
...
create index idx_did
    on confcenter.his_config_info (data_id);

create index idx_gmt_create
    on confcenter.his_config_info (gmt_create);

create index idx_gmt_modified
    on confcenter.his_config_info (gmt_modified);

create table confcenter.permissions
(
...
create table confcenter.tenant_capacity
(
    id                bigint unsigned auto_increment comment '主键ID'
        primary key,
...
create table confcenter.tenant_info
(
    id            bigint auto_increment comment 'id'
        primary key,
...
create index idx_tenant_id
    on confcenter.tenant_info (tenant_id);

create table confcenter.users
(
    username varchar(50)  not null comment 'username'
        primary key,
