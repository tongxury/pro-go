...
func (t *PaymentBiz) CreateSubscriptionEmbedded(ctx context.Context, userId string, params *paymentpb.CreateParams) (string, error) {
	...
	if strings.HasSuffix(params.Cycle, "ly") {
