...
func (t AuthService) GetAppleAuthToken(ctx context.Context, params *ucpb.GetAppleAuthTokenParams) (*ucpb.Token, error) {
	...
	if err != nil {
		log.Errorw("InsertNX err", err, "params", params)
		return nil, err
	}
