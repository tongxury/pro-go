...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldKey, user.FieldNickname, user.FieldEmail, user.FieldPhone, user.FieldPassword, user.FieldStatus, user.FieldChannel, user.FieldAvatar, user.FieldPlatform:
