...
func (pq *PromotionQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *PromotionQuery) FirstIDX(ctx context.Context) int64 {
...
func (pq *PromotionQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *PromotionQuery) OnlyIDX(ctx context.Context) int64 {
...
func (pq *PromotionQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (pq *PromotionQuery) IDsX(ctx context.Context) []int64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
