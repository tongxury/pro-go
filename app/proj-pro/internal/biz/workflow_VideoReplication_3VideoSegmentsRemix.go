...
type VideoSegmentsRemixJob struct {
	data *data.Data
}

func (t VideoSegmentsRemixJob) Initialize(ctx context.Context, options Options) error {
...
func (t VideoSegmentsRemixJob) GetName() string {
