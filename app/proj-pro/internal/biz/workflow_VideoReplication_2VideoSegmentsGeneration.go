...
type VideoSegmentsGenerationJob struct {
	data *data.Data
}

func (t VideoSegmentsGenerationJob) Initialize(ctx context.Context, options Options) error {
	return nil
}

func (t VideoSegmentsGenerationJob) GetName() string {
	return "videoSegmentsGenerationJob"
}

func (t VideoSegmentsGenerationJob) Execute(ctx context.Context, jobState *projpb.Job, wfState *projpb.Workflow) (status *ExecuteResult, err error) {
