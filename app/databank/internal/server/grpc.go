...
func NewGRPCServer(conf confcenter.Server, databank *service.DatabankService, logger log.Logger) *grpc.Server {
	...
	databankpb.RegisterDatabankServer(grpcSrv, databank)
	return grpcSrv
}
