...
const (
	AuthService_SendCode_FullMethodName = "/api.user.AuthService/SendCode"
	AuthService_GetToken_FullMethodName = "/api.user.AuthService/GetToken"
)
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.user.AuthService",
