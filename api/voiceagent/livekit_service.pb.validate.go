	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateConversationRequestValidationError{
					field:  "Topic",
...
// Validate checks the field values on StopConversationRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *StopConversationRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on StopConversationRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// StopConversationRequestMultiError, or nil if none found.
func (m *StopConversationRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *StopConversationRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return StopConversationRequestMultiError(errors)
	}

	return nil
}

// StopConversationRequestMultiError is an error wrapping multiple validation
// errors returned by StopConversationRequest.ValidateAll() if the designated
// constraints aren't met.
type StopConversationRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m StopConversationRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m StopConversationRequestMultiError) AllErrors() []error { return m }

// StopConversationRequestValidationError is the validation error returned by
// StopConversationRequest.Validate if the designated constraints aren't met.
type StopConversationRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e StopConversationRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e StopConversationRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e StopConversationRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e StopConversationRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e StopConversationRequestValidationError) ErrorName() string {
	return "StopConversationRequestValidationError"
}

// Error satisfies the builtin error interface
func (e StopConversationRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sStopConversationRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = StopConversationRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = StopConversationRequestValidationError{}
